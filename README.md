...
https://zenodo.org/account/settings/github/repository/biopragmatics/bioontologies
...
1. Uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to
   ...
   `src/bioontologies/version.py`, and
...
1. Navigate to https://github.com/biopragmatics/bioontologies/releases/new to
   draft a new release
